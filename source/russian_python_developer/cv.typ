...
#align(right)[
  #text(
    ...
    #heading(
      ...
      _Последнее обновление 13 марта 2025_
    ]
  ]
]
...
#par(
  ...
  #align(right)[
    _февраль 2022 — настоящее время (1 год 2 месяца)_
  ]
]
...
• Вёл переговоры с партнёрами из Румынии и Франции по специфике создаваемого продукта.
